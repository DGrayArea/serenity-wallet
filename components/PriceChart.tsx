...
const PriceChart = (props: PropsType) => {
  ...
  useEffect(() => {
    ...
    async function getSolanaData() {
      const url = `https://pro-api.coingecko.com/api/v3/coins/solana/contract/${tokenAddress}/market_chart?vs_currency=usd&days=3`;
      const options = {
        method: 'GET',
