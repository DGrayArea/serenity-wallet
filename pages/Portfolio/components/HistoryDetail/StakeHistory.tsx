...
export default function StakeHistory() {
  return (
    ...
    >
      <BackHeader step={0} title="Stake" className="sticky top-0 z-50" />

      <div className="bg-[#171121] p-4 rounded-lg space-y-4 shadow-md mt-3 mx-3 border border-[#8884FF]">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="flex items-center justify-center bg-[rgba(84,214,255,0.24)] text-white rounded-full w-8 h-8">
              <img src={StakeIcon} alt="Receive Icon" className="w-5 h-5" />
            </div>
        ...
        <div className="grid grid-cols-2 gap-y-4 text-sm text-[#D4CAFF]">
          ...
          <div className="flex flex-col text-right">
            ...
            <div className="text-[#93FF50] text-[13.33px] font-light leading-normal tracking-[0.64px] mt-2">
              <div>+15 SOL</div>
              <div>($3,147.02)</div>
            </div>
          </div>
